    ...
    <div class="newCustContainer">
        <div class="newCustContainerinner">
            <form runat="server">
                ...
                <asp:Literal runat="server"><h2 class="NewCustTitle_2">New Customer Registration</h2></asp:Literal>

                <div class="newCustdiv1">

                    <asp:Label ID="label0" Text="Pet Identification No." runat="server" CssClass="lblLabels" />

                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtPetID_NC" MaxLength="25"></asp:TextBox>
                ...
                <div class="newCustdiv1">
                    ...
                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtOwner_NC" MaxLength="255"></asp:TextBox>
                ...
                <div class="newCustdiv1">
                    ...
                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtGender_NC" MaxLength="1"></asp:TextBox>
                ...
                <div class="newCustdiv1">
                    ...
                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtNumber_NC" MaxLength="12"></asp:TextBox>
                ...
                <div class="newCustdiv1">
                    ...
                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtAddress_NC" MaxLength="255"></asp:TextBox>
                ...
                <div class="newCustdiv1">
                    ...
                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtBreed_NC" MaxLength="255"></asp:TextBox>
                ...
                <div class="newCustdiv1">
                    ...
                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtEmail_NC" MaxLength="255"></asp:TextBox>
                ...
                <div class="newCustdiv1">
                    ...
                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtApptDate_NC" MaxLength="255" placeholder="mm/dd/yyyy"></asp:TextBox>
                    ...
                    <asp:RegularExpressionValidator ValidationExpression="^([0-9]|0[1-9]|1[012])\/([0-9]|0[1-9]|[12][0-9]|3[01])\/(19|20)\d\d$"
                        ControlToValidate="txtApptDate_NC" ErrorMessage="Use MM/DD/YYYY" runat="server" CssClass="RegExVal">
                ...
                <div class="newCustdiv1">
                    ...
                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtApptTime_NC" MaxLength="255" placeholder="Enter Time (00:00)"></asp:TextBox>
                ...
                <div class="newCustdiv1">
                    ...
                    <asp:TextBox runat="server" CssClass="ncInputs" ID="txtEmpId_NC" MaxLength="10"></asp:TextBox>
